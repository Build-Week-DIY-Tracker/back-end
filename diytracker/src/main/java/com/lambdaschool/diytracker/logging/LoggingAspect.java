package com.lambdaschool.diytracker.logging;
...
{
    @Around(value = "@within(com.lambdaschool.diytracker.logging.Loggable) || @annotation(com.lambdaschool.diytracker.logging.Loggable)")
